...
{
    /// <summary>
    /// Represents a filter used to emulate painted by hand
    /// </summary>
    public class PaintedByHandFilter : SmartSpriteOriginalFilterBase, IContrastOrientedObject
    {
        /// <summary>
        ...
        public override bool ApplyFilter(Picture frame, int index)
        {
            ...
            foreach (var columnItem in columnList)
            {
                foreach (var pointItem in columnItem)
                {
                    ...
                    Color currentColor =
                        colorBuffer.GetSimilarColor(pointItem.Color);
        ...
        public override Identification GetIdentification()
        {
            ...
            identification.SetName("Painted By Hand");
            identification.SetDescription("Represents a filter used to emulate paintings made by hand");
